...
const Inventory = () => {
  const { id } = useParams();
  const [product, setProduct, isLoading] = useProductDetail(id);
  ...
  return (
    <div className="my-16">
      ...
      <div className="container mx-auto md:px-20 grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 pt-6 gap-8">
        <div>
        ...
        <div>
          <div className="p-6 flex flex-col justify-start">
            ...
            <p className="text-gray-700 text-base mb-4">
              {product.description || <Skeleton count={10} />}
            </p>
            <Link
              type="button"
              to="/manageInventory"
        ...
        <div>
          <div className="bg-purple-700 text-white p-8">
            ...
            <div className="my-4 text-center">
              ...
              <h6 className="text-xl font-medium">{product.category||<Skeleton/>}</h6>
              <br />
              <p className="font-normal">Brand</p>
              <h6 className="text-xl font-medium">{product.brand||<Skeleton/>}</h6>
              <br />
              <p className="font-normal">Supplier Email</p>
              <h6 className="text-xl font-medium">{product.email||<Skeleton/>}</h6>
              <br />
              <p className="font-normal">Unit Price</p>
              <h6 className="text-xl font-medium">${product.price||<Skeleton/>}</h6>
              <br />
              ...
              <h6 className="text-xl font-medium">{product.sold||<Skeleton/>}</h6>
              <br />
              <button
